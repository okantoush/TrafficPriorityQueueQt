...
DirectionalLight::DirectionalLight(int dir, QPointF topLeft)
...
void DirectionalLight::setColor(QColor c)
{
    m_color = c;
    update();
}

QRectF DirectionalLight::boundingRect() const
{
    return QRectF(0, 0, W, H);
}

void DirectionalLight::paint(QPainter* p,
                             ...
                             QWidget* /*widget*/)
{
    ...
    case 1: c = QPointF(PAD + lensR,     H / 2.0        ); break;   // left   face
